    ...
    <div class="card set">
        ...
        <div class="row">
            ...
            <div class="column large">
                ...
                $sqlSelectBook = "SELECT i.Name, i.itemImgLoc  FROM `article` AS a , `inventory` AS i WHERE i.IID = a.IID ORDER BY `Published_Date` DESC LIMIT 5 OFFSET " . $offset1 . ";";
    ...
    <div class="card set">
        ...
        <div class="row">
            ...
            <div class="column large">
                ...
                $sqlSelectBook = "SELECT i.Name, i.itemImgLoc  FROM `article` AS a , `inventory` AS i WHERE i.IID = a.IID ORDER BY `totalView` DESC LIMIT 5 OFFSET " . $offset2 . ";";
                $resultSelectBook = $con->query($sqlSelectBook);
                if ($resultSelectBook->num_rows > 0) {
                    $numberofrows = $resultSelectBook->num_rows;
            ...
            <div class="column large">
                ...
                <div class="card_column" style="width:2%;">
                    <div style="margin-top: 62px;">
                        ...
                        if ($pageno3 != 0) {
                        ?>
                            <a href="articles.php?p2=<?php echo $pageno3 - 1; ?>" class="page_next">❮</a>
                        <?php
                        } else {
                        }
                ...
                $sqlSelectBook = "SELECT i.Name, i.itemImgLoc  FROM `article` AS a , `inventory` AS i WHERE i.IID = a.IID ORDER BY `totalDownload` DESC LIMIT 5 OFFSET " . $offset3 . ";";
                $resultSelectBook = $con->query($sqlSelectBook);
                if ($resultSelectBook->num_rows > 0) {
                    $numberofrows = $resultSelectBook->num_rows;
